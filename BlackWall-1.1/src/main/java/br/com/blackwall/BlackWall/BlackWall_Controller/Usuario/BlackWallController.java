package br.com.blackwall.BlackWall.BlackWall_Controller.Usuario;
...
import br.com.blackwall.BlackWall.BlackWall_DTO.Usuario.Delete;
import br.com.blackwall.BlackWall.BlackWall_DTO.Usuario.Get;
import br.com.blackwall.BlackWall.BlackWall_DTO.Usuario.Post;
...
import br.com.blackwall.BlackWall.BlackWall_Repository.Usuario.BlackWallRepository;
...
public class BlackWallController {
    ...
    public ResponseEntity<String> CriarCadastro(@RequestBody
        ...
        BlackWall usuario = new BlackWall(null, dados.name(), dados.email(), dados.password(), "USER_ROLE", null);
