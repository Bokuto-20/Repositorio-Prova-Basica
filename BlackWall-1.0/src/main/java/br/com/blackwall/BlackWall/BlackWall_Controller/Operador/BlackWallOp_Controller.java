...
public class BlackWallOp_Controller {
    ...
    public ResponseEntity <String> CriarCadastro(@RequestBody @Valid OPPost dados){
        ...
        BlackWall_Operador operador = new BlackWall_Operador(null, dados.name(), dados.email(), dados.password(), dados.setor(),"OP_Role");
        repository.save(operador);

        BCryptPasswordEncoder encoder = new BCryptPasswordEncoder();
        operador.setPassword(encoder.encode(dados.password()));
